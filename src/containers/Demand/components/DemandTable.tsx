                  ...
                  >
                    ...
                    >
                      <Grid item xs={widthScreen <= 1560 ? 12 : 5} style={{ display: 'flex', alignItems: 'center' }}>
                        <Typography className={classes.fontSizeText12}>データタイプ：</Typography>
                        <Typography variant="subtitle1" className={clsx(classes.fontSizeText12, classes.value)}>
                          {row.fileType}
                        </Typography>
                        <Typography className={classes.fontSizeText12}>ファイルサイズ：</Typography>
                        <Typography variant="subtitle1" className={clsx(classes.fontSizeText12, classes.value)}>
                      ...
                      >
                        <Typography className={classes.fontSizeText12}>アップロード時刻：</Typography>
                        <Typography variant="subtitle1" className={clsx(classes.fontSizeText12, classes.value)}>
                          {isEmpty(row?.originalFiles[0]?.uploadedAt)
                            ? '-'
                            : moment(row?.originalFiles[0]?.uploadedAt).format('YYYY/MM/DD HH:mm:ss')}
                        </Typography>
                        <Typography className={classes.fontSizeText12}>有効期限：</Typography>
                        <Typography variant="subtitle1" className={clsx(classes.fontSizeText12, classes.value)}>
