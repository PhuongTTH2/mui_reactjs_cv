      ...
      <Box className={classes.box}>
        <Table className={classes.table}>
          <TableHead className={classes.tableHead}>
            <TableRow>
              <TableCell className={clsx(classes.tableCell, classes.headerCell)}>店舗名</TableCell>
              <TableCell>制御モード</TableCell>
              <TableCell>充放電ステータス</TableCell>
              <TableCell>蓄電池残量</TableCell>
              <TableCell>容量（合計）</TableCell>
              <TableCell>出力</TableCell>
            </TableRow>
          </TableHead>
          <TableBody className={classes.tableBody}>
            <TableRow>
              <TableCell>XXXXXXXXXXXXXXXXXXXX</TableCell>
              <TableCell>
